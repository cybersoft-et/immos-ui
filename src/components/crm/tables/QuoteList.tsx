...
export default function QuoteList() {
  ...
  const { data: quotes = [], isLoading, refetch } = useQuery({
    queryKey: ['quotes', `${API_BASE}/core/Quotations`],
    queryFn: async () => {
  ...
  const updateMutation = useMutation({
    mutationFn: async (quote) => {
      const response = await fetch(`${API_BASE}/core/Quotations/${quote.id}`, {
        method: 'PUT',
  ...
  const handleSaveEdit = () => {
    updateMutation.mutate(editQuote);
  };
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-[1800px] mx-auto">
        <div className="mb-6 flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-orange-600">Quote Requests</h1>
            ...
            <div className="bg-white rounded-lg shadow-xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="sticky bottom-0 bg-gray-50 border-t border-gray-200 px-6 py-4 flex justify-end gap-3">
                ...
                <button
                  ...
                  className="px-6 py-2.5 bg-orange-700 hover:bg-orange-800 text-white rounded transition-colors font-medium flex items-center gap-2 disabled:opacity-50"
                >
